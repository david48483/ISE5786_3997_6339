...
class RenderStage6Tests {
    ...
    void testRenderAmbientColor() {
        ...
        scene.geometries //
                .add(_sphere.setMaterial(new Material().setKA(0.4)), // TODO by students
                        _triangleLeftTop.setMaterial(new Material().setKA(new Double3(0, 0.8, 0))), // TODO by students
                        _triangleLeftBottom.setMaterial(new Material().setKA(new Double3(0.8, 0, 0))), // TODO by students
                        _triangleRightBottom.setMaterial(new Material().setKA(new Double3(0, 0, 0.8))) // TODO by students
                );
