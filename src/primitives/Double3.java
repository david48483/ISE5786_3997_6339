...
public record Double3(double _d1, double _d2, double _d3) {
    ...
    /**
     * Checks whether at least one component of this triad is greater than or equal to a given value.
     * This is the logical negation of isLowerThan.
     *
     * @param k the value to check against
     * @return {@code true} if at least one component is >= k
     */
